...
## app7.py
Графическое приложение на tkinter: окно с полями «Название», «Исполнитель», «Год», «Длительность» и кнопкой «Добавить». По нажатию кнопки строка добавляется в таблицу `tracks`.

![Окно приложения](screenshot_gui.png)